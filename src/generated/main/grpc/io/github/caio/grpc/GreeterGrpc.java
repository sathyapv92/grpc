...
public final class GreeterGrpc {
  ...
  public static final io.grpc.MethodDescriptor<io.github.caio.grpc.HelloRequest,
      io.github.caio.grpc.HelloResponse> METHOD_SAY_HELLO = getSayHelloMethod();

  private static volatile io.grpc.MethodDescriptor<io.github.caio.grpc.HelloRequest,
      io.github.caio.grpc.HelloResponse> getSayHelloMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<io.github.caio.grpc.HelloRequest,
      io.github.caio.grpc.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<io.github.caio.grpc.HelloRequest, io.github.caio.grpc.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<io.github.caio.grpc.HelloRequest, io.github.caio.grpc.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "helloworld.Greeter", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.caio.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.caio.grpc.HelloResponse.getDefaultInstance()))
